...
public class MatriculaController {
    ...
    public void cadastrar(@RequestBody DadosCadastroMatricula dados) {
        Aluno aluno = alunoRepository.getReferenceById(dados.alunoId());// ERRO 1: O ID do aluno é Integer, mas estava sendo convertido para "String". Isso ocorre porque o "AlunoRepository" também estava configurado incorretamente com "String".
    ...
    // ERRO 8: @PathVariable com nome "ids" não corresponde ao parâmetro {id} da URL
    @DeleteMapping("/{id}")
    @Transactional
